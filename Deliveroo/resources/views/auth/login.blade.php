...
<div class="login_all">
    ...
    <div class="container px-4 py-5 px-md-5 text-center text-lg-start">      
        <div class="row gx-lg-5 align-items-center">
            ...
            <h1 class="display-1 fw-bold ls-tight ms_text-orange position-absolute top-0 start-0 p-5 m-5 bg-light">
                <i class="fa-solid fa-moped"></i>
                DeliveBoo
                <br>
                <span class="display-6 ms_text-purple position-absolute bg-light">
                    - area ristoratore -
                </span>
            </h1>
            </div>
            ...
            <a class="me-5 pe-5 ms_text-orange fw-bold fs-1 text-decoration-none float-end" href="http://127.0.0.1:8000/">{{ __('torna alla home') }}</a>
            </div>
        </div>
        </div>


        {{-- <div class="bg-black text-white position-absolute bottom-0 end-0 d-flex w-100 m-0 flex-row-reverse">
